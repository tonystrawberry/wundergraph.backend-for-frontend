...
export type Queries = {
	AllOrders: {
		input?: undefined;
		response: { data?: AllOrdersResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	AllProducts: {
		input?: undefined;
		response: { data?: AllProductsResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	Dragons: {
